 ...
 */
class WatchFaceService : com.artemchep.essence.service.WatchFaceService() {
    ...
    open inner class WatchFaceEngine : CanvasWatchFaceService.Engine(),
        ...
        override fun onCreate(holder: SurfaceHolder?) {
            ...
            val layoutRes = when (layoutName) {
                Cfg.LAYOUT_HORIZONTAL -> R.layout.watch_face
            ...
            val viewModel = WatchFaceViewModel(
                application,
                Cfg,
                object : ComplicationsPort {
                    override fun setIds(ids: Array<Int>) {
            ...
            viewModel.timeLiveData.observeForever { view.setTime(it); invalidate() }
            viewModel.weatherLiveData.observeForever { view.setWeather(it); invalidate() }
            viewModel.themeLiveData.observeForever { view.setTheme(it); invalidate() }
        }
        ...
        private fun loadThemeFromConfig() {
            ...
            }.copy(clockHourColor = Color.WHITE)
        ...
        private fun updateThemeAccentColorFromConfig() {
            ...
            theme.clockHourColor = Color.WHITE
        ...
        override fun onTimeTick() {
            super.onTimeTick()
            runBlocking {
                val time = System.currentTimeMillis().let(::Time)
        ...
        override fun onAmbientModeChanged(inAmbientMode: Boolean) {
            ...
            view.setArcSectorVisible(ArcSector.TOP_START, !inAmbientMode)
            view.setArcSectorVisible(ArcSector.TOP_END, !inAmbientMode)
            view.setArcSectorVisible(ArcSector.BOTTOM_START, !inAmbientMode)
            view.setArcSectorVisible(ArcSector.BOTTOM_END, !inAmbientMode)
